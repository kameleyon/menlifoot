...
import {
  Body,
  Img, Button, Container, Head, Heading, Hr, Html, Preview, Section, Text,
    ...
    <Body style={main}>
      <Container style={container}>
        <Section style={header}>
          ...
          <Text style={tagline}>Email change</Text>
        </Section>
        <Section style={card}>
          <Heading style={h1}>Confirm your email change</Heading>
          <Text style={text}>
            You requested to change your email from <strong style={emphasis}>{oldEmail}</strong> to <strong style={emphasis}>{newEmail}</strong>.
          </Text>
